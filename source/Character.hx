	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf' | 'bf-bw' | 'bf-kaity' | 'bf-sonic' | 'bf-blue' | 'bf-pump':
				...
				case 'teu':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/Teu', 'shared');
				frames = tex;
			...
			case 'eggdickface': //why was he called this?
				tex = Paths.getSparrowAtlas('characters/eggman_soul', 'shared');
				frames = tex;
...
case 'qt':
	// QT = Cutie
	tex = Paths.getSparrowAtlas('characters/qt', 'shared');
	frames = tex;
...
case 'qt_annoyed':
	//For second song
	tex = Paths.getSparrowAtlas('characters/qt_annoyed', 'shared');
	frames = tex;
...
case 'robot':
	//robot = kb = killerbyte
	tex = Paths.getSparrowAtlas('characters/robot', 'shared');
	frames = tex;
...
case 'gf_404':
	// GIRLFRIEND CODE
	tex = Paths.getSparrowAtlas('characters/GF_assets_404', 'shared');
	frames = tex;
	animation.addByPrefix('cheer', 'GF Cheer', 24, false);
	animation.addByPrefix('singLEFT', 'GF left note', 24, false);
	animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
...
case 'robot_404':
	tex = Paths.getSparrowAtlas('characters/robot_404', 'shared');
	frames = tex;
...
case 'robot_404-TERMINATION':
	tex = Paths.getSparrowAtlas('characters/robot_404-angry', 'shared');
	frames = tex;
...
case 'qt-kb':
	...
	tex = Paths.getSparrowAtlas('characters/qt-kbV2', 'shared');
	frames = tex;
	...
	case 'qt-meme':
	// QT = Cutie
	tex = Paths.getSparrowAtlas('characters/qt_meme', 'shared');
	frames = tex;
	...
	tex = Paths.getSparrowAtlas('characters/robot_classic', 'shared');
	frames = tex;
	...
	case 'robot_classic_404':
		...
		tex = Paths.getSparrowAtlas('characters/robot_classic_404', 'shared');
		frames = tex;
		...
		addOffset("singDOWN", 184, -182);
			...
			danceIdle = true;
	case 'qt_classic':
		tex = Paths.getSparrowAtlas('characters/qt_classic', 'qt');
		frames = tex;
